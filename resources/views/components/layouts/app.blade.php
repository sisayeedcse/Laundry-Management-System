        ...
        <div class="px-6 py-7 flex-shrink-0" style="border-bottom:1px solid rgba(255,255,255,0.05);">
            <div class="flex items-center gap-4">
                <div class="w-11 h-11 rounded-xl flex items-center justify-center flex-shrink-0 logo-ring"
                     style="background:linear-gradient(135deg,#0d9488,#0f766e); width:44px; height:44px;">
                    <svg class="w-6 h-6 text-white" style="width:24px; height:24px; color:#ffffff;" fill="none" stroke="currentColor" viewBox="0 0 24 24">
